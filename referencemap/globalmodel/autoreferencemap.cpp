    ...
    ui(new Ui::AutoReferenceMap)
{
    ...
    QStringList heights = {"0","0.25","0.5","0.75"};
...
void AutoReferenceMap::on_pushButton_clicked()
{
    ...
    case 0: // 0m
    {
        ...
        int seconds = QRandomGenerator::global()->bounded(3, 21); // 3到20之间的随机数
        ...
        QCoreApplication::processEvents();
        accuracy.dataResult(datapoints, filename);
