            ...
            int length)
{
    ...
    {
        MAGtype_CoordGeodetic CoordGeodetic = CoordGeodeticArr[i];
        MAGtype_Date UserDate = UserDateArr[i];
        ...
        // Output
        GeoMagneticElementsArr[i] = GeoMagneticElements;
        ErrorsArr[i] = Errors;
    }
            ...
            int length)
{
    ...
    MAGtype_Geoid Geoid;
    char ans[20], b;
    char filename[] = "./COF/EMM2017.COF";
    char filenameSV[] = "./COF/EMM2017SV.COF";
    ...
    for (Epoch = epochs; Epoch >= 0; Epoch--)
    {
        ...
        if (Epoch < epochs - 1)
        {
            sprintf(filename, "./COF/EMM%d.COF", Epoch + 2000);
            sprintf(filenameSV, "./COF/EMM%dSV.COF", Epoch + 2000);
        }
